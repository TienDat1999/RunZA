...
export default class CustomExample extends Component {
        ...
        return (
            <View colors={[, '#0000', '#00029']}
                ...
                <View style={{
                    ...
                    <View style={{ flex: .66, height: 60, width: 60, borderRadius: 80, borderWidth:1, borderColor:'white' }}
                        />
    ...
    render() {
        const props = {
            ...
            icon: 'iconUrl',
            onRowPress: (item, index) => { this.alert(item.name + " clicked", item.score + " Steps, wow!") },
            sort: this.sort
        }    
